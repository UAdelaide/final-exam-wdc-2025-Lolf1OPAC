...
((SELECT dog_id FROM Dogs WHERE name = 'JeffBezos'), '2025-06-20 09:00:00', 3000, 'River Trail', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Thanos'), '2025-06-20 11:00:00', 3000, 'Central Park', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'HulkyBoy'), '2025-06-20 08:45:00', 40000, 'Sunset Blvd', 'cancelled');
