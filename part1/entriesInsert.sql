...
((SELECT dog_id FROM Dogs WHERE name = 'JeffBezos'), '2025-06-11 07:00:00', 60, 'River Trail', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Thanos'), '2025-06-11 10:00:00', 30, 'Central Park', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'HulkyBoy'), '2025-06-12 08:30:00', 40, 'Sunset Blvd', 'cancelled');
