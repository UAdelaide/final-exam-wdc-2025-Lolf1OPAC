...
((SELECT dog_id FROM Dogs WHERE name = 'JeffBezos'), '2025-06-20 09:00:00', 60, 'River Trail', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Thanos'), '2025-06-20 11:00:00', 30, 'Central Park', 'open'),
